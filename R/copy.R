...
#'
#' Copies a database connection to a file or to another database connection.  It can be used to save an in-memory database
#' (created using `dbname = ":memory:"` or `dbname = "file::memory:"`) to a file
