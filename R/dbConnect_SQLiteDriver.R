...
#' @param drv,conn An object generated by [SQLite()], or an existing
#'   \code{\linkS4class{SQLiteConnection}}. If a connection, the connection
#'   will be cloned.
...
#'   significant speed ups using `synchronous = "off"`, and the SQLite
