...
#' @param drv,conn An object generated by [SQLite()], or an existing \code{\linkS4class{SQLiteConnection}}.
#'   If a connection, the connection will be cloned.
...
#'   Users have reported significant speed ups using `synchronous = "off"`,
