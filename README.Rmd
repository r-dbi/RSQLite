...
# Pin `max.print` so the rendered output does not depend on the renderer's own
# option. R's default is 99999, which prints all 32 rows of the `dbReadTable()`
# result below; the committed README shows the truncated form. Without this, the
# file changes for whoever re-renders it next, depending on their `.Rprofile`.
