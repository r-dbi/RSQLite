...
- Update revdep report from revdep4 run (most, depth 1)
  ([\#793](https://github.com/r-dbi/RSQLite/issues/793)).
...
- Break lines at meaning boundaries
  ([\#787](https://github.com/r-dbi/RSQLite/issues/787)).

- Drop the branch from the coverage badge
  ([\#785](https://github.com/r-dbi/RSQLite/issues/785)).

- Harmonize README and pkgdown front page rendering
  ([\#786](https://github.com/r-dbi/RSQLite/issues/786)).

- Use [`pak::pak()`](https://pak.r-lib.org/reference/pak.html) for the
  development install
  ([\#783](https://github.com/r-dbi/RSQLite/issues/783)).
...
- Ci: Fail the roxygenize step on roxygen2 warnings
  ([\#111](https://github.com/r-dbi/RSQLite/issues/111)).

## RSQLite 3.53.3.9009 (2026-09-05)
...
## RSQLite 3.53.3.9008 (2026-08-08)
...
- Auto-update from GitHub Actions
  ([\#777](https://github.com/r-dbi/RSQLite/issues/777)).
...
- Ci: Give every workflow and job an explicit `permissions` block
  ([\#103](https://github.com/r-dbi/RSQLite/issues/103)).

- Ci: Pass workflow context through the environment, not into script
  text ([\#102](https://github.com/r-dbi/RSQLite/issues/102)).

- Ci: Add a Windows arm64 (`windows-11-arm`) check on R-release
  ([\#99](https://github.com/r-dbi/RSQLite/issues/99)).
...
- New
  [`sqliteIsTransacting()`](https://rsqlite.r-dbi.org/dev/reference/sqlite-transaction.md)
...
- Add test for interrupt behavior in
  [`sqliteSetBusyHandler()`](https://rsqlite.r-dbi.org/dev/reference/sqliteSetBusyHandler.md)
...
- The `row.names` argument to
  ...
  [`dbWriteTable()`](https://dbi.r-dbi.org/reference/dbWriteTable.html),
  [`sqliteBuildTableDefinition()`](https://rsqlite.r-dbi.org/dev/reference/sqliteBuildTableDefinition.md),
...
- Improve warning message if named parameters are not used in
  [`dbGetPreparedQuery()`](https://rsqlite.r-dbi.org/dev/reference/query-dep.md)
  or
  [`dbSendPreparedQuery()`](https://rsqlite.r-dbi.org/dev/reference/query-dep.md)
...
- [`RSQLite()`](https://rsqlite.r-dbi.org/dev/reference/SQLite.md) no
  longer automatically attaches DBI when loaded. This is to encourage
  you to use
...
- [`sqliteCopyDatabase()`](https://rsqlite.r-dbi.org/dev/reference/sqliteCopyDatabase.md)
...
- Start on a basic vignette:
  [`vignette("RSQLite")`](https://rsqlite.r-dbi.org/dev/articles/RSQLite.md)
...
- Added
  [`datasetsDb()`](https://rsqlite.r-dbi.org/dev/reference/datasetsDb.md),
  a bundled SQLite database containing all data frames in the datasets
...
- [`dbBeginTransaction()`](https://rsqlite.r-dbi.org/dev/reference/dbBeginTransaction.md)
...
- Renamed
  [`dbBuildTableDefinition()`](https://rsqlite.r-dbi.org/dev/reference/sqliteBuildTableDefinition.md)
  to
  [`sqliteBuildTableDefinition()`](https://rsqlite.r-dbi.org/dev/reference/sqliteBuildTableDefinition.md)
