...
|RSQLite  |   |1.0.0      |2016-08-31 |local (rstats-db/RSQLite@NA)     |
...
|   |package           | check_time|
|:--|:-----------------|----------:|
|3  |AnnotationHubData |     4908.9|
|62 |OrganismDbi       |        873|
|36 |GenomicFeatures   |      840.9|
|20 |cummeRbund        |      537.2|
|42 |lumi              |      461.3|
|92 |SRAdb             |      421.8|
...
Processing /tmp/Rtmpld05Vq/filed17f6acacbde in chunks of 10000
Starting chunk 1
...
Last 13 lines of output:
  ...
  In addition: Warning message:
  closing unused connection 3 (/tmp/RtmpkhqABk/filed232615f71d4) 
  Execution halted
