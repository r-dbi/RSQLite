...
Examples with CPU or elapsed time > 5s
                   user system elapsed
AnnDbPkg-checker 33.852  0.344   34.22
...
Examples with CPU or elapsed time > 5s
                user system elapsed
getResultVars  6.356  0.064   6.477
addExperiments 5.920  0.088   6.083
...
Examples with CPU or elapsed time > 5s
                   user system elapsed
batchReduceResults 5.36  0.028   5.401
```
...
New session 2016-09-01 10:00:46
PROJECT: test.sqlite 
DIRECTORY: /tmp/RtmpCTytIe
...
Last 13 lines of output:
  ...
  ERROR in /tmp/RtmpwKR0G6/RLIBS_7a505af72b1/specL/unitTests/test_read.bibliospec.R: Error while sourcing  /tmp/RtmpwKR0G6/RLIBS_7a505af72b1/specL/unitTests/test_read.bibliospec.R : Error in dbGetException(con)$errorNum : 
    $ operator is invalid for atomic vectors
  
  Test files with failing tests
  
     test_read.bibliospec.R 
       /tmp/RtmpwKR0G6/RLIBS_7a505af72b1/specL/unitTests/test_read.bibliospec.R 
